...
class TestMetrics(IntegrationTest):
    ...
    def test_unknown_sequence(self):
        from azafea.event_processors.endless.metrics.v3.model import Request, UnknownSequence
    ...
    def test_invalid_sequence(self, capfd):
        from azafea.event_processors.endless.metrics.v3.model import Request, InvalidSequence
